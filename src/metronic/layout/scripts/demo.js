...
**/
var App = require('../../global/scripts/app');
var Layout = require('./layout');

var storage = window.Cookies;
...
var Demo = function() {
    ...
    var setThemeStyle = function(style) {
        ...
        if (typeof storage !== "undefined") {
            storage.set('layout-style-option', style);
        }
    };
    ...
    return {
        ...
        init: function() {
            ...
            if (typeof storage !== "undefined" && storage.get('layout-style-option') === 'rounded') {
                setThemeStyle(storage.get('layout-style-option'));
                $('.theme-panel .layout-style-option').val(storage.get('layout-style-option'));
            }
        }
    };
