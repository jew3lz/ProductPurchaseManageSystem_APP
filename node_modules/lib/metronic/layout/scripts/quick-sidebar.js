...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        $('.dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler, .quick-sidebar-toggler').click(function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            setTimeout(function(){
                ...
                var st_message = preparePost('in', (st_time.getHours() + ':' + st_time.getMinutes()), "Ella Wong", 'avatar2', 'Lorem ipsum doloriam nibh...');

                chatContainer.append($(st_message));
                chatContainer.slimScroll({
                    scrollTo: '1000000px'
                });
            }, 3000);
